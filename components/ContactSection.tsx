  ...
  return (
    <section id="contact" className="py-10 px-6 bg-white">
      <div className="w-full">
        ...
        <div className="group relative border border-gray-200 bg-white px-12 py-12 flex flex-col md:flex-row md:items-center md:justify-between gap-8 shadow-[0_18px_55px_rgba(24,32,56,0.12)] transition-all duration-700 hover:-translate-y-1 hover:shadow-[0_24px_65px_rgba(24,32,56,0.15)] mt-8">
          <span className="absolute inset-x-0 -top-px h-1 bg-gradient-to-r from-gray-400 via-gray-700 to-gray-900"></span>
          <div>
