...
<section className="relative h-[80vh] overflow-hidden">
      ...
      <section className="py-32 px-6">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="group relative border border-gray-200 bg-white px-12 py-16 shadow-[0_18px_55px_rgba(24,32,56,0.12)] overflow-hidden">
            ...
            <div className="pointer-events-none absolute -top-24 -right-16 w-80 h-80 bg-gradient-to-br from-[#f6e27a]/25 via-transparent to-transparent blur-3xl"></div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="group relative border border-gray-200 bg-white px-12 py-16 shadow-[0_18px_55px_rgba(24,32,56,0.12)] overflow-hidden">
            <span className="absolute inset-x-0 -top-px h-1 bg-gradient-to-r from-[#f6e27a] via-[#d2c7ff] to-[#b3e1ff]"></span>
            <div className="pointer-events-none absolute -top-20 -left-16 w-72 h-72 bg-gradient-to-br from-[#d2c7ff]/25 via-transparent to-transparent blur-3xl"></div>
            <div className="space-y-6 relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                {[
                  ...
                  <div key={item.title} className="relative pl-6">
                    <span className="absolute left-0 top-2 h-12 w-[3px] bg-gradient-to-b from-[#f6e27a] via-[#d2c7ff] to-[#b3e1ff]"></span>
